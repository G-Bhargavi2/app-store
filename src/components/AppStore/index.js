    ...
    return (
      <div className="app-container">
        <div className="store-container">
          ...
          <ul className="apps-container">{this.renderApps()}</ul>
        </div>
      </div>
    )
  }
